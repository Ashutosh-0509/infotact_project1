...
export default function Employees() {
  ...
  const cashierCount = employees.filter(e => e.role === 'Cashier' && e.isActive).length;
      ...
      <div className="space-y-6">
            ...
            <CardContent>
              <div className="text-sm space-y-1">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{cashierCount}</span>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Feature access overview by role.</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="overflow-x-auto">
              <table className="w-full text-sm text-left">
                ...
                <tbody className="divide-y border-b">
                  {[
                    { feature: 'POS Billing', c: 'Yes', m: 'Yes', a: 'Yes' },
                    { feature: 'View Inventory', c: 'No', m: 'Yes', a: 'Yes' },
                    { feature: 'Edit Inventory', c: 'No', m: 'Yes', a: 'Yes' },
                    { feature: 'View Reports', c: 'No', m: 'Yes', a: 'Yes' },
                    { feature: 'Manage Users', c: 'No', m: 'No', a: 'Yes' },
                    { feature: 'Finance Access', c: 'No', m: 'No', a: 'Yes' },
                    { feature: 'System Settings', c: 'No', m: 'No', a: 'Yes' },
                    { feature: 'Export Data', c: 'No', m: 'Yes', a: 'Yes' },
                  ].map((row, i) => (
                    <tr key={i} className="hover:bg-muted/50">
                      <td className="px-4 py-2 font-medium">{row.feature}</td>
                      <td className="px-4 py-2">
                        <Badge variant={row.c === 'Yes' ? 'default' : 'secondary'} className="px-1 text-[10px] uppercase font-bold">{row.c}</Badge>
                      </td>
                      <td className="px-4 py-2">
                        <Badge variant={row.m === 'Yes' ? 'default' : 'secondary'} className="px-1 text-[10px] uppercase font-bold">{row.m}</Badge>
                      </td>
                      <td className="px-4 py-2">
                        <Badge variant={row.a === 'Yes' ? 'default' : 'secondary'} className="px-1 text-[10px] uppercase font-bold">{row.a}</Badge>
                      </td>
                    </tr>
                  ))}
                </tbody>
