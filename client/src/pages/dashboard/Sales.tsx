...
export default function Sales() {
  ...
  const sales = [
    { id: "#T89341", customer: "Rajesh Kumar", items: 4, amount: "₹1,250", method: "UPI", status: "Completed", time: "2:30 PM" },
    { id: "#T89342", customer: "Priya Sharma", items: 2, amount: "₹850", method: "Cash", status: "Pending", time: "2:45 PM" },
    { id: "#T89343", customer: "Amit Patel", items: 1, amount: "₹450", method: "Card", status: "Completed", time: "3:00 PM" },
    { id: "#T89344", customer: "Sunita Devi", items: 6, amount: "₹2,100", method: "UPI", status: "Cancelled", time: "3:15 PM" },
    { id: "#T89345", customer: "Walk-in", items: 3, amount: "₹600", method: "Cash", status: "Completed", time: "3:30 PM" },
  ];
