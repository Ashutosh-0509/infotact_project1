...
import { BarChart, EyeOff, Eye, ArrowLeft, Loader2, AlertCircle } from 'lucide-react';
...
export default function ManagerLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const result = await login({ email, password, role: 'Manager' });
  ...
  return (
    <div className="min-h-screen w-full flex bg-background">
      ...
      <div className="hidden lg:flex w-1/2 flex-col justify-between p-12 lg:p-24 relative overflow-hidden" 
        ...
        <div className="relative z-10">
          ...
          <motion.p 
            ...
            className="text-green-100 text-lg lg:text-xl max-w-md leading-relaxed"
          >
            Inventory control, stock management, and team oversight
          </motion.p>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center p-8 lg:p-24 relative bg-white">
        ...
        >
          <div className="mb-8">
            <h2 className="text-3xl font-bold" style={{ color: '#16a34a' }}>Manager Login</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              <Label htmlFor="email">Manager ID or Email</Label>
              <Input
                id="email"
                type="text"
          ...
          <div className="mt-8 pt-8 border-t border-border">
            ...
            <button
              onClick={fillDemo}
              className="w-full p-4 rounded-xl border border-green-100 bg-green-50/50 hover:bg-green-50 transition-colors text-left flex justify-between items-center group"
            >
              <div>
                <p className="text-sm font-semibold text-green-900">Manager</p>
                <p className="text-xs text-green-600/80 mt-1">manager@pos.com / manager123</p>
              </div>
